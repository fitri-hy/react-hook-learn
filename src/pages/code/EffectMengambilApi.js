...
function EffectMengambilApi() {
  const language = "javascript";
  const [code, setCode] = useState("");
  useEffect(() => {
    const loadFile = async () => {
      try {
        const response = await fetch('/code/useeffect-mengambilapi.txt');
...
export default EffectMengambilApi;
