...
function EffectMengaturUlang() {
  const language = "javascript";
  const [code, setCode] = useState("");
  useEffect(() => {
    const loadFile = async () => {
      try {
        const response = await fetch('/code/useeffect-mengaturulang.txt');
...
export default EffectMengaturUlang;
